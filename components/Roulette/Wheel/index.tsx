...
import { RouletteContainer, RotationContainer } from './styles';
import {
...
export const Wheel = ({
	...
	return (
		<div>
			<RouletteContainer className='h-[80vw] w-[80vw] md:h-[35vw] md:w-[35vw] lg:h-[42vw] lg:w-[42vw] xl:h-[45vw] xl:w-[45vw]'>
				<RotationContainer
